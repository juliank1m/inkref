...
NOTES = [
    ...
    (0, ""),
    (0, "A LIMIT DESCRIBES THE VALUE A FUNCTION"),
    (0, "APPROACHES AS THE INPUT GETS CLOSE TO"),
    (0, "SOME POINT. IT NEED NOT BE DEFINED THERE."),
    (0, ""),
    (0, "THREE THINGS MUST HOLD FOR CONTINUITY"),
    (1, "- THE FUNCTION IS DEFINED AT THE POINT"),
    (1, "- THE LIMIT EXISTS THERE"),
    (1, "- THE TWO AGREE"),
    (0, ""),
    (0, "THE DERIVATIVE IS THE LIMIT OF THE"),
    (0, "DIFFERENCE QUOTIENT AS H GOES TO ZERO"),
]
